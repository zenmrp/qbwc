...
Gem::Specification.new do |s|
  ...
  s.homepage    = ''
  s.summary     = "A Rails interface for Intuit's Quickbooks Web Connector"
  s.description = "A Rails interface for Intuit's Quickbooks Web Connector that's OPEN SOURCE!"
